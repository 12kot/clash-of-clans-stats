...
export const selectBasicCardsClanByFilter = createSelector(
  ...
  (activeSort, clans) => {
    ...
    if (activeSort.key === "capitalLevel")
      return clans
        .slice()
        .sort((a, b) => a.mainInfo.capital.value - b.mainInfo.capital.value);
    ...
    if (activeSort.key === "members")
      return clans
        .slice()
        .sort((a, b) => a.otherInfo.members.value - b.otherInfo.members.value);
    ...
    if (activeSort.key === "capitalTrophies")
      return clans
        .slice()
        .sort((a, b) => a.trophies.capital.value - b.trophies.capital.value);
...
export const selectBasicCardsPlayerByFilter = createSelector(
  ...
  (activeSort, players) => {
    ...
    if (activeSort.key === "mainLegend")
      return players
        .slice()
        .sort((a, b) => a.trophies.mainLegend.value - b.trophies.mainLegend.value);
